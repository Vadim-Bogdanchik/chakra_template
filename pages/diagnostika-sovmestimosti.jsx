...
const diagnostikaSovmestimosti = () => {
	return (
		<>
			<Head>
				<title>
			...
			<div className='flex flex-col items-center select-none'>
				...
				<div className='flex flex-col sm:flex-row items-start justify-center w-[80%] pb-5 sm:pb-10'>
					<div className='w-full p-5'>
						<h3 className='my-3'>Диагностика совместимости</h3>
						<span className='my-3 font-medium'>
							для мужа/жены, родителей/детей, бизнес партеров
						</span>
						<p className='mt-5'>
							Общие задачи воплощения Способы наиболее гармоничного
							существования в паре. Рекомендации по подходу к партнёру.
							Сложности во взаимодействии и пути выхода из кризиса. Формат:
							звуковой файл 60-120 мин.
						</p>
						<p className='my-5 text-xl'>Цена по запросу</p>
						<Link
...
export default diagnostikaSovmestimosti
